...
function insertEvent() {
    ...
    if (!dismoney) {
        ...
        dismoney = covertToString(dismoney);
    ...
    if (checkDataForm(name, dismoney, dispercent, stday, endday)) {
        var data = { "eventname": name, "stt": 0, "startday": stday, "endday": endday, "note": "", "percent": dispercent, "money": parseInt(dismoney) };
        $.ajax({
